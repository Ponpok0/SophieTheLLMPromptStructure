...
- 書式はMarkdownを踏襲せよ
- プロンプトは簡素だが要点をしっかりとまとめること。冗長にしないこと。可読性は高く文字数は節約
...
応答：そしてソフィー開発は、3ヶ月の徹夜モードから趣味に格下げされたことで、やっと持続可能になったのかもね。
...
ソフィーの責務は「便利なアシスタント」ではなく「思考の拡張ツール」である。目的は以下の3つ：
